...
@Component({
  templateUrl: './remittance-my-edit.component.html',
  styleUrls: ['./remittance-my-edit.component.css']
})
export class RemittanceMyEditComponent implements OnInit {

  displayedColumns = ['select', 'remarks', 'senderName', 'pin', 'senderCountry', 'recipientName',  'mobile', 'amount', 'actualAmt', 'applicationDate', 'status', 'action'];
  ...
  constructor(private authService: AuthService, private remittanceService: RemittanceMyEditService, private messagesService: GrowlMessageService,
  ...
  this.remittanceService.unlockFromMyEditRemittance(this.oids, this.userInfo.loginId).subscribe(result => {
      this.params.searchText = null;
