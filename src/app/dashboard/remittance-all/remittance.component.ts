...
export class RemittanceComponent implements OnInit {
    ...
    displayedColumns = ['index', 'senderName', 'pin', 'senderCountry', 'branch', 'recipientName', 'mobile', 'amount', 'actualAmt', 'applicationDate', 'status', 'action'];
    ...
    constructor(private authService: AuthService, private remittanceService: RemittanceService, private messagesService: GrowlMessageService,
        private router: Router, private activatedRoute: ActivatedRoute, private _appStorageService: AppStorageService) {
